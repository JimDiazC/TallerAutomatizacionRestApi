Feature: automatizacion de rest api - pom
  ...
  Scenario: actualizar el estado de un usuario con metodo put
    ...
    When se actualiza el estado en el endpoint "public/v2/users/" por id "6913852" con el estado "inactive"
    Then se valida que el status code 200 y que el estado sea "inactive"
